...
const DATASET_EXPORT_FALLBACKS: Record<string, ExportPlan> = {
  base_contact: {
    ...
    columns: [
      ...
      { source: 'outcome_subtype', alias: 'subresultado' },
      { source: 'outcome_reason', alias: 'motivo_resultado' },
      ...
      { source: 'callback_at', alias: 'fecha_rellamado' },
      { source: 'sold_at', alias: 'fecha_venta' },
      { source: 'priority_score' },
      { source: 'contactability_score' },
      { source: 'purchase_propensity_score' },
      { source: 'segmento_tamano_empresa' },
      { source: 'rubro_economico_ultimo' },
      { source: 'subrubro_economico_ultimo' },
      { source: 'actividad_economica_ultima' },
      { source: 'tramo_ventas_2024' },
      { source: 'region' },
      { source: 'comuna' },
      { source: 'domicilio_direccion' },
      { source: 'dataset_refreshed_at' },
    ],
  },
  pernat_resumen: {
